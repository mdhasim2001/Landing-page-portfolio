...
const Qualification = ({open, close}) => {
    return (
        <div className={`${open ? "hidden lg:block" : "hidden"} fixed inset-0 w-4/5 h-4/5 m-auto bg-white p-5  rounded-lg qualification`}>
            ...
            <div className="grid grid-cols-2 gap-5">
                <div className="text-center">
                    <div>
                        <h1 className="text-center my-5 text-xl font-bold ">Skill</h1>
                ...
                <div>
                    <h1 className="text-center my-5 text-xl font-bold">Education</h1>
                    <div className="ml-20">
                        <div>
