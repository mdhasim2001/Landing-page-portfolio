...
const Qualification = ({open, close}) => {
    return (
        <div id="qualification"  className={`${open ? "" : "lg:hidden"} lg:bg-black bg-opacity-50 lg:fixed lg:flex items-center justify-center lg:inset-0 lg:w-full lg:h-[100vh] z-50 mt-10 lg:mt-0 pt-24 lg:pt-0 `}>
            <div className={`lg:w-4/5 lg:h-4/5 lg:bg-white lg:p-5  lg:rounded-lg lg:shadow-inner lg:qualification`}>
